...
const Layout = () => {
  return (
    <div className="px-2 lg:px-0 relative flex flex-col gap-y-6 justify-center items-center bg-blur-ellipse-small bg-[center_top_-1rem] bg-[length:200px] bg-no-repeat">
      <div className="z-10">
