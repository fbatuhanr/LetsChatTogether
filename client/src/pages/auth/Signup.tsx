...
export const Signup: React.FC = () => {
    ...
    const { register, formState: { errors }, watch, handleSubmit } = useForm<SignupProps>()
                            ...
                            <input type="text" className="bg-[#0D0D0D] rounded-2xl px-6 py-4" placeholder="type here..."
                                {...register("username", {
                                    ...
                                    pattern: {
                                        ...
                                        message: "Must be 3-16 char long and only lower letters, digits, ., _, or -."
                                    }
                                })}
                            />
                        ...
                        <div className="flex flex-col gap-y-1">
                            ...
                            <input type="password" className="bg-[#0D0D0D] rounded-2xl px-6 py-4" placeholder="type here..."
                                {...register("password", {
                                    ...
                                    pattern: {
                                        value: /^[A-Za-z\d]{8,20}$/,
                                        message: "Must be 8-20 char long and include only letters and digits"
                                    }
                                })}
                            />
                            <div className="text-sm px-4 min-h-5">
