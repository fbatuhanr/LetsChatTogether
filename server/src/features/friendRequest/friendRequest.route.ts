...
router.get('/status', authenticateToken, friendRequestController.getRequestStatusBetweenUsers)
...
router.get('/incoming/:userId', authenticateToken, friendRequestController.getIncomingRequests);
router.get('/outgoing/:userId', authenticateToken, friendRequestController.getOutgoingRequests);
